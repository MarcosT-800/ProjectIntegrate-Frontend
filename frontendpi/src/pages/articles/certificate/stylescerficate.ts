...
.hora_data {
  ...
  width: 80%;
  height: 80vh;
  margin-top: 10px; /* Add top margin to prevent overlapping with header */
 ...
 /*  @media (max-width: 1600px) {
    height: 80vh; /* Reduce card height for smaller screens */
  }

 /*  @media (max-width: 1200px) {
     height: 100vh; /* Use full viewport height for very small screens */
  /* }  */
}
